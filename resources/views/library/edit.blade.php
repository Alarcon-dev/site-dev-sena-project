...
@section('content')
    <section class="section">
        ...
        <div class="section-body" style="margin-top: 8%">
            <h2 class="section-title">Editar recursos</h2>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="/resource/update/{{ $resource->id_resources }}" method="POST"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control" name="resource_title"
                                            ...
                                            value="{{ isset($resource) ? $resource->resource_title : '' }}">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <textarea class="summernote-simple" name="resource_description" @error('resource_description') is-invalid @enderror">
                                            {{ isset($resource) ? $resource->resource_description : '' }}
                                        </textarea>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            ...
                                            <input type="hidden" name="file_name"
                                                value="{{ isset($resource) ? $resource->resource_file : '' }}">
                                        </div>
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <div id="image-preview" class="image-preview">
                                                ...
                                                @if ($resource->resource_image)
                                                    <img src="/resource/image/{{ $resource->resource_image }}"
                                                        alt="">
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" class="form-control inputtags" name="resource_author"
                                                ...
                                                value="{{ isset($resource->resource_author) ? $resource->resource_author : '' }}">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="date" class="form-control inputtags" name="resource_edition"
                                                ...
                                                value="{{ isset($resource->resource_edition) ? \Carbon\Carbon::parse($resource->resource_edition)->format('Y-m-d') : '' }} ">
