...
@section('content')
    @if ($publication->count() > 0 && $publication !== null)
        <section class="section" style="margin-top: 8%;">
            <div class="section-body">
                <h2 class="section-title">Editar publicación</h2>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="/save/publication" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-8">
                                            <input type="text" name="public_title"
                                                ...
                                                value="{{ $publication->public_title }}">
                                            @error('public_title')
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-8">
                                            <select
                                                class="form-control selectric @error('cate_public_id') is-invalid @enderror"
                                                name="cate_public_id">
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->id_categorie }}"
                                                        <?= isset($publication) && $publication->cate_public_id === $category->id_categorie ? 'selected' : '' ?>>
                                    ...
                                    <div class="form-group row mb-4 editor">
                                        ...
                                        <div class="col-sm-12 col-md-8">
                                            <textarea id="myTextarea" class="shadow @error('public_content') is-invalid @enderror" name="public_content">{{ isset($publication->public_content) ? $publication->public_content : '' }}</textarea>
